 ...
 */
public class AddHeaderFooterAdapter extends BaseQuickAdapter<OrdinaryBean, BaseViewHolder> {

    public AddHeaderFooterAdapter(@LayoutRes int layoutResId, @Nullable List<OrdinaryBean> data) {
